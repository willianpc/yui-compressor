...
public class CompressUtils {
	...
	public static void compressJS(String ftc, String cf)
					throws EvaluatorException, IOException {
		compressJS(new File(ftc), new File(cf));
	}
	...
	public static void compressCSS(String ftc, String cf)
					throws FileNotFoundException, IOException {
		compressCSS(new File(ftc), new File(cf));
	}
}
